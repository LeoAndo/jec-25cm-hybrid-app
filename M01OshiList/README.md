...
Monacaのコマ1〜4で作る「推しログ」の完成プロジェクトです。音楽・お店・道具などのお気に入りを一覧にし、押した項目の詳しい内容を表示します。授業では静的なカードから順に作り、この完成版は動作確認とコード比較に使います。

## 画面の構成

| 画面 | 表示するもの | 操作 |
| --- | --- | --- |
| 一覧 | 名前、ジャンル、選択した項目 | 行を押すと、その項目の詳細を開く |
| 詳細 | 名前、ジャンル、お気に入りの理由 | 左上の「戻る」で一覧へ戻る |
...
| `www/css/style.css` | 余白、文字の色と大きさ、詳細コメントの改行 |
